                        ...
                        <form action="login" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <fieldset>
                                        <div class="row">
                                            <div class="col-md-6"><span>Don't have an account?</span> <a href="registerView.jsp">Register</a></div>
                                            <div class="col-md-6 text-right"><a href="resetPassView.jsp">Forgot password?</a></div>
                                        </div>
                                    </fieldset>
                                    <p><br/></p>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <fieldset>
                                        <div class="col-md-24 text-center"><button type="submit" id="form-submit" class="mx-auto btn">Login</button></div>
                                    </fieldset>
                                </div>
                            </div>
                        </form>
